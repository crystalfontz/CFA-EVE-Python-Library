...
HPX = 320	# Horizontal Pixel Width
HSW = 10	# Horizontal Sync Width (1~40)
HBP = 20	# Horizontal Back Porch (must be 46, includes HSW)
HFP = 10	# Horizontal Front Porch (16~210~354)
HPP = 150	# Horizontal Pixel Padding (tot=863: 862~1056~1200)
...
VLH = 240	# Vertical Line Height
VS = 3		# Vertical Sync (in lines)  (1~20)
VBP = 0	# Vertical Back Porch (must be 23, includes VS)
