...
HBP = 10	# Horizontal Back Porch (must be 46, includes HSW)
HFP = 38	# Horizontal Front Porch (16~210~354)
HPP = 73	# Horizontal Pixel Padding (tot=863: 862~1056~1200)
...
VLH = 320	# Vertical Line Height
VS = 4		# Vertical Sync (in lines)  (1~20)
VBP = 4	# Vertical Back Porch (must be 23, includes VS)
