...
#Dither for lower bitdepth panels
LCD_DITHER = 1
...
HSW = 11		# Horizontal Sync Width (1~40)
HBP = 6		# Horizontal Back Porch (must be 46, includes HSW)
HFP = 24	# Horizontal Front Porch (16~210~354)
HPP = 521	# Horizontal Pixel Padding (tot=863: 862~1056~1200)
...
VBP = 3		# Vertical Back Porch (must be 23, includes VS)
VFP = 4		# Vertical Front Porch (7~22~147)
