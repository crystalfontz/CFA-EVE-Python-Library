...
HPX = 1024	# Horizontal Pixel Width
HSW = 1		# Horizontal Sync Width (1~40)
HBP = 160	# Horizontal Back Porch (must be 46, includes HSW)
HFP = 16	# Horizontal Front Porch (16~210~354)
HPP = 396	# Horizontal Pixel Padding (tot=863: 862~1056~1200)
...
VLH = 600	# Vertical Line Height
VS = 1		# Vertical Sync (in lines)  (1~20)
VBP = 23	# Vertical Back Porch (must be 23, includes VS)
VFP = 1		# Vertical Front Porch (7~22~147)
