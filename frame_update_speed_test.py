...
while True:
	...
	eve.buffer_cocmd_add(eve.defs.EVE_ENC_BITMAP_HANDLE(0))
	eve.cocmd.set_bitmap(0, eve.defs.EVE_FORMAT_RGB565, IMAGE_SIZE[0], IMAGE_SIZE[1])
	eve.buffer_cocmd_add(eve.defs.EVE_ENC_COLOR_RGB(255,255,255))
	eve.buffer_cocmd_add(eve.defs.EVE_ENC_BEGIN(eve.defs.EVE_BEGIN_BITMAPS))
	eve.buffer_cocmd_add(eve.defs.EVE_ENC_VERTEX2F(0, 0))
	eve.buffer_cocmd_add(eve.defs.EVE_ENC_END())
